...
class Student:
    ...
    def __init__ (self,root):
        ...
        self.MName = Label(frame1, font=('Vogue',12), text="Middle Name:",bg="#003A6C", fg = "white", anchor=W)
        ...
        self.pYLevel = ttk.Combobox(frame1, font=('Vogue',12,'bold'), state='readonly', width=39, textvariable = YLevel)
